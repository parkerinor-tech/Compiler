...
protected:
    ...
    // helpers to access protected child methods from subclass
    cAstNode* GetChildProtected(int index) { return cAstNode::GetChild(index); }
    void SetChildProtected(int index, cAstNode* node) { cAstNode::SetChild(index, node); }
};